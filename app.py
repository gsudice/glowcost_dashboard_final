...
import pylayout
# import pyfunc, pyfigure, pyfunc, pylayoutfunc  # pylint: disable=multiple-imports

# Load template from pytemplate - Pytemplates is a lightweight 
# HTML template engine written in Python, with support for template 
# inheritance, blocks, macros, context, and Django.
...
# This is the template layout - remove once done with app dev - cleaned
# app.layout = dbc.Container(
#     [
#         pylayout.HTML_TITLE,
#         pylayout.HTML_NAVBAR,
#         pylayout.HTML_DROPDOWN,
...
#     print('context trigger prop is: ', context_trigger_prop_id)
